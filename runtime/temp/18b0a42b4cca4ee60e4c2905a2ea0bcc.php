<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:36:"./oscshop/admin/view/goods/edit.html";i:1552894032;s:37:"./oscshop/admin/view/public/base.html";i:1512008342;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
        ...
        <form action="<?php echo url('Goods/add'); ?>" method="post" enctype="multipart/form-data" id="form-goods" class="form-horizontal">
          ...
          <div class="tab-content">
	          	...
	          	<div class="tab-pane active" id="tab-data">
					...
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-meta-title2">商品原价：</label>
						<div class="col-sm-10">
							<input id="input-meta-title2" class="form-control" type="text" placeholder="商品原价" value="" name="originalprice">
						</div>
					</div>
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-meta-title2">利润：</label>
						<div class="col-sm-10">
							<input id="input-meta-title2" class="form-control" type="text" placeholder="利润" value="" name="profit">
						</div>
					</div>
					<div class="form-group required">
					...
					<div class="form-group required">
						<label class="col-sm-2 control-label" for="input-meta-title2">商品销量：</label>
						<div class="col-sm-10">
							<input id="input-meta-title2" class="form-control" type="text" placeholder="商品销量" value="" name="salesvolume">
						</div>
					</div>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" >固定券码：</label>
						
							<div class="col-sm-10">
								<label class="radio-inline">
								<input type="radio" value="1" name="coupon_type">是</label>
								<label class="radio-inline">
								<input type="radio" checked="checked" value="0" name="coupon_type">否</label>
							</div>
					...
					<div class="form-group required">
						...
						<div class="col-sm-10">
							<input id="input-meta-title2" class="form-control" type="text" placeholder="运费" value="" name="weight">
						</div>
					</div>

					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-length-class">运费单位：</label>
						<div class="col-sm-10">
...
function addOptionValue(option_row,type) {	
	...
	html += '  <input type="text" name="goods_option[' + option_row + '][goods_option_value][' + option_value_row + '][originalprice]" value="" class="form-control" /></td>';
	html += '  <input type="text" name="goods_option[' + option_row + '][goods_option_value][' + option_value_row + '][salesvolume]" value="" class="form-control" /></td>';
	html += '  <input type="text" name="goods_option[' + option_row + '][goods_option_value][' + option_value_row + '][coupon_type]" value="" class="form-control" /></td>';
...
$('#goods-brand').delegate('.fa-minus-circle', 'click', function() {
	...
	function addDiscount() {
		...
		html += '  <td class="text-left"><input type="text" name="goods_discount[' + discount_row + '][originalprice]" value="" class="form-control" /></td>';
		html += '  <td class="text-left"><input type="text" name="goods_discount[' + discount_row + '][coupon_type]" value="" class="form-control" /></td>';
