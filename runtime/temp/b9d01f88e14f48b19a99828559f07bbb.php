<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./oscshop/mobile/view/order/order_info.html";i:1542386538;s:38:"./oscshop/mobile/view/public/base.html";i:1516611140;s:41:"./oscshop/mobile/view/public/top-nav.html";i:1512008342;s:44:"./oscshop/mobile/view/public/footer-nav.html";i:1512628884;}*/ ?>
<!DOCTYPE HTML>
<html>
...
<script src="__PUBLIC__/js/jquery/JsBarcode.all.js"></script>
...
<div class="exp-item-info">
    ...
    <?php if(is_array($order['order_product']) || $order['order_product'] instanceof \think\Collection || $order['order_product'] instanceof \think\Paginator): $i = 0; $__LIST__ = $order['order_product'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?>
        <div class="clearfix items" onclick="location = '<?php echo url("goods/detail",array("id"=>$d["goods_id"])); ?>';">
            <img class="ucoi-pic" src="IMG_ROOT<?php echo resize($d['image'],100,100); ?>">
            <div class="ucoi-con">
...
<div class="exp-item-info">
 <div class="exp-item-caption">券码信息</div>
<?php if(is_array($coupon_code) || $coupon_code instanceof \think\Collection || $coupon_code instanceof \think\Paginator): $i = 0; $__LIST__ = $coupon_code;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
 <img src="<?php echo 'http://weiqin.gxwdbg.com/barcodegen/example/code/test_code39.php?text=';?><?php echo $v['coupon_code']; ?>" width="100%" alt="barcode" />
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
</div>


<!--<h1 style="text-align:center"><font>券码：<?php echo $coupon_code; ?></font></h1>-->
<div class="exp-item-info">
...
<script>
	JsBarcode("#barcode", "18082053481015");
