<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./oscshop/mobile/view/discount/discount.html";i:1541660378;s:38:"./oscshop/mobile/view/public/base.html";i:1516611140;s:41:"./oscshop/mobile/view/public/top-nav.html";i:1512008342;s:44:"./oscshop/mobile/view/public/footer-nav.html";i:1512628884;}*/ ?>
<!DOCTYPE HTML>
<html>
...
<div class="TopcaptionPos"></div>
	...
	<div id="subtitle_next" class="red">
		<div class="next_seckill">
			<a href="<?php echo url('Discount/index'); ?>" class="next">查看上场抢购商品&gt;&gt;</a>
		</div>
	</div>
			...
			<a href="" class="sku_item">
				...
				<div class="seckill_meta">
					...
					<p class="seckill_price">
						...
						<del>&yen;<?php echo $v['0']['price']; ?></del>
					</p>
...
<script>
	function countTime(){
		...
		var start = new Date('<?php echo $timeon; ?>').getTime();
		// start = start*1000;
		console.log(start)
