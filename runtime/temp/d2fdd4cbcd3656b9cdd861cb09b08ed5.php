<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./oscshop/mobile/view/cart/index.html";i:1545979482;s:38:"./oscshop/mobile/view/public/base.html";i:1516611140;s:41:"./oscshop/mobile/view/public/top-nav.html";i:1512008342;}*/ ?>
<!DOCTYPE HTML>
<html>
...
<div class="weui_btn_area">
	...
	<a class="weui_btn weui_btn_primary payment" id="integration-payment-btn" style="margin: -5px;padding: 9px 0;">手机积分支付</a>
</div>
</div>
<?php else: ?>
<div class="weui_btn_area">
...
<div class="weui_btn_area mui-content-padded">
	<a class="weui_btn weui_btn_primary payment" id="integration-payment-btn">手机积分支付</a>
</div>
<textarea name="poi_num" id="poi_num" cols="0" rows="0"></textarea>
<?php endif; else: ?>   
<div class="weui_btn_area">
...
<?php endif; endif; ?>
<!-- 选择积分支付弹窗 start-->
<div id="Selection_form" class='weui-popup-container popup-bottom'>
			...
			<div class="weui_cells weui_cells_form">
				<div class="weui_cell">
					<div class="weui_cell_bd weui_cell_primary">
						<a class="weui_btn weui_btn_primary payment" id="moving_integral">移动和支付</a>
						<a class="weui_btn weui_btn_primary payment" id="wing_payment">电信翼支付</a>
					</div>
				</div>
			</div>
		</div>
...
<div id="moving_integral_form" class='weui-popup-container popup-bottom'>
	<div class="weui-popup-overlay"></div>
	<div class="weui-popup-modal">
		...
		<div class="modal-content" style="padding-top: 0">
			<div class="weui_cells weui_cells_form">
				<div class="weui_cell" style="display: block;">
					<a class="weui_btn weui_btn_primary cancel_button" href="javascript:" id="cancel_button">取消</a>
				</div>

				<div class="weui_cell">
					<div class="weui_cell_bd weui_cell_primary">
						<input class="weui_input" name="tell" id="tell" type="text" placeholder="手机号码">
					</div>
				</div>
				<!--<div class="weui_cell">
					<div class="weui_cell_bd weui_cell_primary">
						<input class="weui_input code-input" name="code" id="code" type="text" placeholder="验证码">
						<button type="" id="sendcode" class="code-button">点击获取</button>
					</div>
				</div>-->
				
				<div class="weui_btn_area">
					<button type="" id="hbpay"  class="code-button" style="position: relative;display: block;margin-left: auto;margin-right: auto;padding: 0px;padding-right: 14px;box-sizing: border-box;font-size: 18px;text-align: center;text-decoration: none;color: #fff;line-height: 2.33333333;border-radius: 5px;-webkit-tap-highlight-color: rgba(0,0,0,0);overflow: hidden;background-color: #04be02;width:100%;border:none">确定</button>
					<textarea style="display:none;" name="acceptid" id="acceptid" cols="20" rows="12" " ></textarea>
				</div>
			</div>
		</div>
	</div>	
...
<div id="wing_payment_form" class='weui-popup-container popup-bottom'>
	<div class="weui-popup-overlay"></div>
	<div class="weui-popup-modal">
		<input type="hidden" id="update_type" value="add"> 
		<input type="hidden" id="update_address_id" value="0">      
		<div class="modal-content" style="padding-top: 0">
			<div class="weui_cells weui_cells_form">
				...
				<div class="weui_cell">
					<div class="weui_cell_bd weui_cell_primary">
						<input class="weui_input" name="phone" id="phone"  type="text" placeholder="手机号码">
					</div>
				</div>
				<div class="weui_cell">
					<div class="weui_cell_bd weui_cell_primary">
						<!-- <input class="weui_input code-input" name="code" type="text" placeholder="验证码">  
						<button type="" id="sendcodedx"  class="code-button" style="position: relative;display: block;margin-left: auto;margin-right: auto;padding: 0px;padding-right: 14px;box-sizing: border-box;font-size: 18px;text-align: center;text-decoration: none;color: #fff;line-height: 2.33333333;border-radius: 5px;-webkit-tap-highlight-color: rgba(0,0,0,0);overflow: hidden;background-color: #04be02;width:100%;border:none">确定</button>-->
						<button type="" id="sendcodedx"  class="code-button" style="position: relative;display: block;margin-left: auto;margin-right: auto;padding: 0px;padding-right: 14px;box-sizing: border-box;font-size: 18px;text-align: center;text-decoration: none;color: #fff;line-height: 2.33333333;border-radius: 5px;-webkit-tap-highlight-color: rgba(0,0,0,0);overflow: hidden;background-color: #04be02;width:100%;border:none">确定</button>
					</div>
				 </div>
				
				<!-- <div class="weui_btn_area"> -->
					<!-- <a class="weui_btn weui_btn_primary confirm_button" href="javascript:" id="confirm_button">确定</a> -->
...
<script>
		 $(function(){
			$('#integration-payment-btn').live('click', function() {
				$.closePopup(); 
				clear_form();
				$("#Selection_form").popup();
			});
			$('#moving_integral').live('click', function() {
				$.closePopup(); 
				clear_form();
				$("#moving_integral_form").popup();
			});
			$('#wing_payment').live('click', function() {
				$.closePopup(); 
				clear_form();
				$("#wing_payment_form").popup();
			});
		...
		$('#sendcode').live('click', function() {
				var tell =  $("#tell").val();
				$.ajax({
				      url: '<?php echo url("Payment/sendcode"); ?>',
				      Type: "get",
				      data: "tell="+tell,
				      dataType: "json",
				      success: function sendcode(data) {
				      			
								//alert(data);
				      			document.getElementById("acceptid").value = data;
				        }
				        })
				//开始倒计时
...
$('#sendcodedx').click(function(){
	...
	$.post(
		'<?php echo url("payment/sendcodedx"); ?>',
		{
			phone:phone,
			city_id:city_id,
			comment:comment,
...
$('#jf-payment-btn').click(function(){
	...
	$.post(
		...
		function(d){
			...
			document.getElementById("poi_num").value = d;
			if(d.error){
				$.toast(d.error, "forbidden");
			}
