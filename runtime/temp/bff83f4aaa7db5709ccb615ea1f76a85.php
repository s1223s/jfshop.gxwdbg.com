<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:39:"./oscshop/mobile/view/goods/detail.html";i:1549098676;s:38:"./oscshop/mobile/view/public/base.html";i:1516611140;s:41:"./oscshop/mobile/view/public/top-nav.html";i:1512008342;}*/ ?>
<!DOCTYPE HTML>
<html>
...
<a class="uc-add-like">收藏</a>
    ...
    <?php if(!empty($discountms)): if(is_array($discountms) || $discountms instanceof \think\Collection || $discountms instanceof \think\Paginator): $i = 0; $__LIST__ = $discountms;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
            	<dl class="pd-dsc clearfix">
            	<dt>秒杀价：</dt>
            	 <dt class="prices" data-price="<?php echo round($v['discount_price'],2); ?>" id="pd-market-price">&yen;<?php echo round($v['discount_price'],2); ?></dt>
            	</dl>
            <?php endforeach; endif; else: echo "" ;endif; else: if(isset($points_goods) AND ($points_goods == 'points')): ?>
   	...
   	<?php endif; endif; if(!empty($goods['originalprice'])): ?>
		<dl class="pd-dsc clearfix">
	        <dt>原价：</dt>
	        <dt class="prices" data-price="<?php echo round($goods['originalprice'],2); ?>" id="pd-market-price">&yen;<?php echo round($goods['originalprice'],2); ?></dt>
	   	</dl>
	<?php endif; ?>
   	<dl class="pd-dsc clearfix" id="product_stock_wrap">
        ...
        <dt id="pd-stock"><?php echo $goods['quantity']; ?></dt>
       	...
       	<dl class="pd-dsc clearfix" id="product_stock_wrap">
        <dt>销量：</dt>
        <dt id="pd-stock"><?php echo $sales_volume; ?></dt>
    </dl>
...
<a href="<?php echo url('merchant/index',array('id'=>$merchantNo)); ?>" class="Mshop">
	<i class="icon_shop"></i>
	进入店铺
</a> 
...
$(function(){
    ...
    $('#buy-button,#addcart-button').bind('click', function() {		
		...
		$.ajax({
				//alert($('#container input[type=\'hidden\'],#container input[type=\'radio\']:checked,#container input[type=\'checkbox\']:checked,#container select'));
