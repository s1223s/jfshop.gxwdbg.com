<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./oscshop/mobile/view/agent_backend/sub_order.html";i:1512008342;s:37:"./oscshop/admin/view/public/base.html";i:1512008342;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<div class="table-responsive">
			<table id="table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<tr>		
							<td><a href='<?php echo url("member/OrderBackend/show_order",array("id"=>$v["order_id"])); ?>'> <?php echo $v['order_num_alias']; ?> </a></td>
