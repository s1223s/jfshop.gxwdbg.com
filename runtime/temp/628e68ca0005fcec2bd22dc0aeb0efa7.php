<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./oscshop/mobile/view/agent_level/index.html";i:1512008342;s:37:"./oscshop/admin/view/public/base.html";i:1512008342;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('AgentBackend/add_level'); ?>" class="btn btn-primary">新增代理等级</a>
</div>		
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<tr>
							...
							<td><?php echo num_to_percent($d['return_percent']); ?></td>
							<td>
								<a  class="btn btn-xs btn-info" href='<?php echo url("AgentBackend/edit_level",array("id"=>$d["al_id"])); ?>'>
									<i class="fa fa-edit bigger-120"></i>
								</a> 
								<a class="delete btn btn-xs btn-danger" href='<?php echo url("AgentBackend/del_level",array("id"=>$d["al_id"])); ?>' >
