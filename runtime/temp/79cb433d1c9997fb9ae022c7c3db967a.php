<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./oscshop/mobile/view/agent_level/edit.html";i:1512008342;s:37:"./oscshop/admin/view/public/base.html";i:1512008342;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="row">
	<div class="col-xs-12">	
			...
			<input name="al_id" type="hidden" value="<?php echo \think\Request::instance()->param('id'); ?>" />
			<?php endif; ?>
					
			<div class="form-group required">
				<label class="col-sm-2 control-label">代理等级：</label>
				<div class="col-sm-10">
					<input  class="form-control" type="text" placeholder="代理等级" name="type"  value="<?php echo (isset($d['type']) && ($d['type'] !== '')?$d['type']:''); ?>" />
				</div>
			</div>			
			...
			<div class="form-group required">
				...
				<div class="col-sm-10">
					<input  class="form-control" type="text" placeholder="等级名称" name="name"  value="<?php echo (isset($d['name']) && ($d['name'] !== '')?$d['name']:''); ?>" />
				</div>
			</div>
									
			<div class="form-group required">
				<label class="col-sm-2 control-label">返佣比例：</label>
				<div class="col-sm-10">
					<input  class="form-control" type="text" placeholder="返佣比例" name="return_percent"  value="<?php echo (isset($d['return_percent']) && ($d['return_percent'] !== '')?$d['return_percent']:''); ?>" />
				</div>
			</div>
...
var back_index="<?php echo url('AgentBackend/level'); ?>";
