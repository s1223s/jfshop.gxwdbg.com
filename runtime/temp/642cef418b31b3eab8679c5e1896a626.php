<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"./oscshop/mobile/view/agent_backend/sub_member.html";i:1512008342;s:37:"./oscshop/admin/view/public/base.html";i:1512008342;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<div class="table-responsive">
			<table id="table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<tr>		
							<td><img src="<?php echo $v['userpic']; ?>/64" /></td>
						...
						<tr>
							<td colspan="20" class="page">总计 <?php echo ($list->total() ?: "0"); ?> 个</td>
						</tr>
				</tbody>
