<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"./oscshop/admin/view/business/index.html";i:1515146206;s:37:"./oscshop/admin/view/public/base.html";i:1512008342;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<?php if(\think\Request::instance()->param('pid')): ?>
		...
		<a href="<?php echo url('business/create_group',array('pid'=>input('param.pid'))); ?>" class="btn btn-primary">新增</a>
	<?php else: ?>
		<!--<a href="<?php echo url('Category/add'); ?>" class="btn btn-primary">新增</a>-->
		<a href="<?php echo url('business/create_group'); ?>" class="btn btn-primary">新增</a>
	<?php endif; ?>
</div>	
<table class="table table-striped table-bordered table-hover search-form">
	<thead>
		<th><input name="user_name" type="text" placeholder="输入商家用户名" value="<?php echo input('param.business_name'); ?>" /></th>		
