<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./oscshop/admin\view\citizencard\index.html";i:1541553601;s:37:"./oscshop/admin\view\public\base.html";i:1512008342;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="row">
	...
	<thead>
		...
		<th><input name="name" type="text" placeholder="输入市民卡号" value="<?php echo input('name'); ?>" /></th>
		
		<th>
			<a class="btn btn-primary" href="javascript:;" id="search" url="<?php echo url('Citizencard/index'); ?>">查询</a>
		</th>
	</thead>
</table>
			<table id="table" class="table table-striped table-bordered table-hover">
				...
				<tbody>
						<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
						<tr>		
							<td>
							<?php echo $v['cardid']; ?>
							</td>				
