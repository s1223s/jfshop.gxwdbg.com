<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"./oscshop/admin/view/category/edit.html";i:1512008342;s:37:"./oscshop/admin/view/public/base.html";i:1512008342;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
	            ...
	            <div class="col-sm-10" id="thumb">
	                  <a id="thumb-image" href="#" data-toggle="image" class="img-thumbnail">
		                  	<?php if(!empty($cat['image'])): ?>
		                  		<img src="IMG_ROOT<?php echo resize($cat['image'],100,100); ?>" />
		                  	<?php else: ?>
