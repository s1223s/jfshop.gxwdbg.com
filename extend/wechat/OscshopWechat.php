...
final class OscshopWechat extends Wechat
{
	...
	private function getAccessToken($code){
       ...
       $RequestUrl            = "https://api.weixin.qq.com/sns/oauth2/access_token?appid=".'wxda24132f43802300'."&secret=".$this->config['appsecret']."&code=" . $code . "&grant_type=authorization_code";
